...
(function() {
    ...
    (0, _router.initRouter)(rootElement);
})();
...
function initRouter(container) {
    function handleRoute(route) {
        const routes = [
            ...
            {
                path: /\/play/,
                component: (0, _play.initGameplay)
            },
            {
                path: /\/results/,
                component: (0, _results.initGame)
            }
        ];
        function goTo(path) {
...
},{"./pages/welcome/welcome":"3RBva","./pages/instructions/instructions":"j0BpH","./pages/play/play":"5pGj4","./pages/results/results":"9DlQ7","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3RBva":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initWelcome", ()=>initWelcome);
function initWelcome(params) {
    const gameLogo = require("8ceaff6d62bc1f20");
...
},{"8ceaff6d62bc1f20":"4YvlW","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"4YvlW":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("piedra-papel-tijeras.97be2fe8.svg") + "?" + Date.now();
...
},{}],"j0BpH":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initInstructions(params) {
    ...
    div.innerHTML = `
        <p class="instructions__text">Presion\xe1 jugar y eleg\xed: piedra, papel o tijera antes de que pasen los 3 segundos.</p>
        <button class="btn">\xa1Jugar!</button>
     `;
    const btn = div.querySelector(".btn");
    btn.addEventListener("click", ()=>{
        params.goTo("play");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5pGj4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initGameplay", ()=>initGameplay);
var _manos = require("../../components/manos");
var _state = require("../../state");
function initGameplay(params) {
    (0, _manos.manos)();
    const div = document.createElement("div");
    div.innerHTML = `
    ...
    const intervaloId = setInterval(()=>{
        ...
        if (counter > 3) {
            ...
            params.goTo("results");
            const currentGame = (0, _state.state).getState().currentGame;
            (0, _state.state).pushToHistoty(currentGame);
        }
    }, 1000);
    return div;
}

},{"../../components/manos":"hwzZA","../../state":"dWXvP","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hwzZA":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "manos", ()=>manos);
var _state = require("../state");
function manos() {
    class Manos extends HTMLElement {
        ...
        render() {
            // Importa imágenes
            const imgPiedra = require("74fca3bb2a2f9fee");
            const imgPapel = require("f04667af4c81f73a");
            const imgTijera = require("3a90418682a6c20d");
            // Cambia la opción seleccionada
            function handleOption(optionSelected, optionsGame) {
                optionsGame.forEach((option)=>{
                    option.classList.add("unselected");
                    if (option.classList[1] && option.classList[1] == "selected") option.classList.remove("selected");
            ...
            optionsGame.forEach((item)=>{
                item.addEventListener("click", ()=>{
                    ...
                    (0, _state.state).setGame(item.id);
                });
            });
    ...
    if (!customElements.get('manos-component')) customElements.define('manos-component', Manos);
}

},{"../state":"dWXvP","74fca3bb2a2f9fee":"1yxbK","f04667af4c81f73a":"am1L6","3a90418682a6c20d":"5Coju","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dWXvP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const state = {
    ...
    setGame (option) {
        ...
        let computerOption = (0, _lodash.random)(1, 3);
    ...
    pushToHistoty (play) {
        this.data.history.games.push({
            ...play
        });
        if (play.computerPlay !== play.personPlay) this.whoWins(play.personPlay, play.computerPlay) ? this.data.history.points.person += 1 : this.data.history.points.computer += 1;
    },
    // Procesa el ganador
...
},{}],"1yxbK":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("piedra.0f38c998.svg") + "?" + Date.now();

},{}],"am1L6":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("papel.17717846.svg") + "?" + Date.now();

},{}],"5Coju":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("tijera.d89b5ce5.svg") + "?" + Date.now();

},{}],"9DlQ7":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initGame", ()=>initGame);
var _state = require("../../state");
function initGame(params) {
    const data = (0, _state.state).getState();
    const currentGame = data.currentGame;
    const history = data.history;
    const imgWin = require("bfe665d96d7fc5de");
    const imgLoser = require("51fc32a2ead4ed30");
    const imgEmpate = require("5da0159aa3a7c3c8");
    const imgList = {
        piedra: require("4b50f021e48e868c"),
        papel: require("ebe3b9849210747d"),
        tijera: require("8ea4825ef0be0520")
    };
    const div = document.createElement("div");
    ...
    div.innerHTML = `
        ...
        <div class="results">
            ...
            <div class="score">\
                ...
                <p class="score__computer-title">M\xe1quina: <span class="score__computer-number"></span></p>
            </div>
    ...
    const intervaloId = setInterval(()=>{
        ...
        const resultsImg = div.querySelector(".results__img");
        if (counter > 1) {
            const resulWhoWin = (0, _state.state).whoWins(currentGame.personPlay, currentGame.computerPlay);
...
},{"../../state":"dWXvP","bfe665d96d7fc5de":"7Tood","51fc32a2ead4ed30":"ih4Id","5da0159aa3a7c3c8":"9IAUW","4b50f021e48e868c":"1yxbK","ebe3b9849210747d":"am1L6","8ea4825ef0be0520":"5Coju","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7Tood":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("win.d23b4598.svg") + "?" + Date.now();

},{}],"ih4Id":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("loser.a25cc6f8.svg") + "?" + Date.now();

},{}],"9IAUW":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("empate.9ad4f395.svg") + "?" + Date.now();

},{}]},["3dtlh","gH3Lb"], "gH3Lb", "parcelRequire8661", {}, "./", "/")

//# sourceMappingURL=piedra-papel-tijeras.34df32e0.js.map
